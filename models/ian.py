...
class IAN(nn.Module):
    def __init__(self, embedding_matrix, opt):
        ...
        self.attention_aspect = Attention(opt.hidden_dim, score_function='bi_linear',n_head=2)
        self.attention_context = Attention(opt.hidden_dim, score_function='bi_linear',n_head=2)
